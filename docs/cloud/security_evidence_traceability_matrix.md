...
Generated: `2026-07-24T23:34:00.320136+00:00`
...
| TRACE-005 | Corpus | Which approved evidence artifacts are available for retrieval? | `ai/security_evidence_corpus_manifest.csv` | **TRACEABLE** | records=61 |
| TRACE-006 | Corpus | What is the approved local evidence corpus content? | `ai/security_evidence_corpus.jsonl` | **TRACEABLE** | records=61 |
...
| TRACE-008 | Answer Layer | Did the answer layer cite approved local evidence? | `ai/security_evidence_answer_sources.csv` | **TRACEABLE** | SEC-EVID-0010=1; SEC-EVID-0011=1; SEC-EVID-0039=1; SEC-EVID-0040=1; SEC-EVID-0047=1 |
